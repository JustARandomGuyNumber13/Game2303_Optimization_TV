...
{
    [SerializeField] int damagePerShot = 20;        // Changed to private since nothing else is accessing these informations _TV_
    ...
    float timer;
    bool isShooting;    // New input system check _TV_
